...
SELECT FIRST_NAME, LAST_NAME, A.ADDRESS_ID,ADDRESS, PHONE
FROM ADDRESS a right outer join CUSTOMER C ON C.ADDRESS_ID = A.ADDRESS_ID;

--right outer join ONLY UNIQUE FOR RIGHT TABLE
SELECT FIRST_NAME, LAST_NAME, A.ADDRESS_ID,ADDRESS, PHONE
FROM CUSTOMER C right outer join ADDRESS A ON C.ADDRESS_ID = A.ADDRESS_ID;

SELECT FIRST_NAME, LAST_NAME, A.ADDRESS_ID,ADDRESS, PHONE
FROM ADDRESS a LEFT outer join CUSTOMER C ON C.ADDRESS_ID = A.ADDRESS_ID;
